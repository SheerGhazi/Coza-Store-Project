                  ...
                  <div className="flex items-center border border-gray-300 rounded bg-red-100 bg-opacity-50">
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M12 6.5C7.857 6.5 4.5 9.857 4.5 14c0 .905.29 1.738.784 2.415l1.532-1.532c-.036-.109-.065-.22-.065-.338 0-.894.722-1.616 1.616-1.616.118 0 .229.029.338.065l1.532-1.532c-.677-.494-1.51-.784-2.415-.784-2.481 0-4.5 2.019-4.5 4.5s2.019 4.5 4.5 4.5 4.5-2.019 4.5-4.5c0-.118-.029-.229-.065-.338l1.532-1.532C13.738 18.71 14.571 19 15.5 19c4.143 0 7.5-3.357 7.5-7.5S19.143 4.5 15 4.5zM12 8c1.93 0 3.5 1.57 3.5 3.5S13.93 15 12 15s-3.5-1.57-3.5-3.5S10.07 8 12 8z"
                        ></path>
                      </svg>
                    </button>
                  </div>
